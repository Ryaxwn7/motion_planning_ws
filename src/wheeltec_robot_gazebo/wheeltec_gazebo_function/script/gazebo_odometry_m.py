...
class OdometryNode:
    ...
    def sub_robot_pose_update(self, msg):
        ...
        model_name = self.tf_prefix
        target_link = f"{model_name}::base_footprint"
        try:
            arrayIndex = msg.name.index(target_link)          
    ...
    def timer_callback(self, event):
        ...
        cmd.header.frame_id = self.tf_prefix + '/odom'
        cmd.child_frame_id = self.tf_prefix + '/base_footprint'
