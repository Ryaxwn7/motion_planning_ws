 ...
 */
class AStar_M : public GlobalPlanner
{
public:
  /**
   ...
   */
  AStar_M(costmap_2d::Costmap2D* costmap, bool dijkstra = false, bool gbfs = false);

  double GetCost(std::vector<Node>& last_path, const Node& node);
  /**
