// fm2star_planner.h
#ifndef FM2STAR_PLANNER_H
#define FM2STAR_PLANNER_H
...
#include "fastmarching/fm2/fastmarching2star.hpp"
...
class FM2Star_Planner : public GlobalPlanner 
{
public:
    FM2Star_Planner(costmap_2d::Costmap2D* costmap);
    FM2Star_Planner(costmap_2d::Costmap2DROS* costmapROS, costmap_2d::Costmap2D* costmap);
    FM2Star_Planner(costmap_2d::Costmap2DROS* costmapROS, costmap_2d::Costmap2D* costmap,
                    const ros::NodeHandle& nh);
    ~FM2Star_Planner()=default;
